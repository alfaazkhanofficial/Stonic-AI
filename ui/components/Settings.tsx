...
import { Settings2, SlidersHorizontal, Palette, UserRound, ShieldCheck, Download, Upload, RotateCcw, ArrowUpRight, Mic } from 'lucide-react';
...
export function SettingsPanel({ initialCategory, onClose, onSaved }: {initialCategory?: string; onClose: () => void; onSaved: () => void}) {
  ...
  const categories = [ ['AI & Providers', SlidersHorizontal], ['Appearance', Palette], ['Personalization', UserRound], ['Privacy', ShieldCheck], ['Memory', SlidersHorizontal], ['Tasks & Automation', SlidersHorizontal], ['Computer Control', SlidersHorizontal], ['Events & Proactive', SlidersHorizontal], ['Gaming', SlidersHorizontal], ['Voice', Mic] ] as const;
